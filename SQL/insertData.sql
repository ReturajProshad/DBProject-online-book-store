...
INSERT INTO Customers (CustomerID, Name, Email, Phone) VALUES(2, 'Bob Brown', 'bob.brown@example.com', '098-765-4321');
select * from customers;

-- Insert data into Purchases table
INSERT INTO Purchases (PurchaseID, CustomerID, PurchaseDate) VALUES
(1, 1, TO_DATE ('2024-02-15','YYYY-MM-DD'));
...
INSERT INTO PurchaseItems (PurchaseItemID, PurchaseID, BookID) VALUES
(1, 1, 1);
